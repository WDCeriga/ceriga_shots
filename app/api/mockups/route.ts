...
const PRESET_BASE: Record<Preset, string> = {
  ...
  studio: [
    ...
    '  - Contact shadow: tight perimeter ~1–2mm',
    '  - Cast shadow: very short and faint (length typically ~0.5–2cm depending on shot), opacity ~8–15%',
...
const PRESET_BY_CATEGORY: Record<Preset, Record<ShotCategory, string>> = {
  ...
  studio: {
    ...
    surface: [
      ...
      '- Shadows: soft minimal grounded; contact shadow tight (~1–2mm); cast shadow very short and faint (typically ~0.5–2cm) with smooth penumbra.',
